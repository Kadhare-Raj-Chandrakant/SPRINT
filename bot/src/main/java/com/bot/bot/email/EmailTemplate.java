...
public class EmailTemplate {
            ...
            + row(
                twoCol(
                    vAlign(left, "",
                        ...
                        + "vertical-align:middle;font-size:12px;font-weight:700;color:#fff;" + FW + "\">G</td>"
                        + "<td style=\"padding-left:10px;font-size:18px;font-weight:700;color:#fff;\" " + FW + ">glint</td>"
                        + "</tr></table>") +
    ...
    private static String brandFooter() {
        return row(
            ...
            + "Sent by <strong style=\"color:" + BODY + "\">glint</strong> &mdash; PR Triage Bot</p>"
        );
    }
